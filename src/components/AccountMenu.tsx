            ...
            <div id="account_settings">
                ...
                <div id="options">
                    <svg id="calendar_btn" viewBox="0 0 283.5 283.5">
                        <path className="theme_fill" d="M211,28.3v47.9h-45V28.3h-48.6v47.9h-45V28.3H0v247.2h283.5V28.3H211z M258.5,250.5H25v-160h233.5V250.5z"/>
                        <g>
                            <rect x="82.4" className="theme_fill" width="25" height="67"/>
                            <rect x="176" className="theme_fill" width="25" height="67"/>
                        </g>
                        <g>
                            <path className="theme_fill" d="M153.3,193.2c0,6.6-1.1,12.8-3.3,18.4c-2.9,7.9-7.9,14-14.8,18.4c-6.9,4.4-15.1,6.6-24.6,6.6
                            ...
                            <path className="theme_fill" d="M191.1,106.2h22.3c0.6,0,1.1,0.2,1.6,0.6c0.4,0.4,0.6,1,0.6,1.6V233c0,0.6-0.2,1.1-0.6,1.6
                    ...
                    <svg id="delete_button" viewBox="0 0 283.5 283.5">
                        <path className="theme_fill" d="M45.2,65.4l27.7,218h137.7l27.7-218H45.2z M114.9,266.6H90L74.2,96.2h32.5L114.9,266.6z M154.2,266.6h-24.9
                                		l-3.8-170.4H158L154.2,266.6z M193.5,266.6h-24.9l8.2-170.4h32.5L193.5,266.6z"/>
                        <rect className="theme_fill st0" x="32.6" y="16" width="218.4" height="31.9"/>
                        <rect className="theme_fill st0" x="114.9" width="53.7" height="31.9"/>
                    </svg>
                </div>
                <label><span id="name">Kontoname</span>
                    <input type="text" className="name" name="name" autoComplete="off"/>
                </label>
                <label><span id="interest_rate">Zinssatz</span>
                    <input type="text" className="name" name="interest_rate" autoComplete="off"/>
                </label>
                <div className="contain_two">
                    <label><span id="color_span">Themenfarbe</span>
                        <span id="color_picker" className="theme_background"></span>
                    </label>
                    <label className="container"><span id="negative_span">Überziehen erlauben</span>
                        <input type="checkbox" name="negative_values"/>
                        <span className="toggle_checkbox"></span>
                    </label>
                </div>
                <button id="save_acc_set" type="button" className="theme_background">Speichern</button>
            </div>
        </aside>
    );
}